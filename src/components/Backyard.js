...
import backYardSittingOne from './41back.jpg';
export default class Backyard extends Component{

  render(){
    return(
    <div className = 'Backyard'>
    <h2 className='pageTitle'>Backyard</h2>
    <img className ="roomImage" src={backYardSittingOne} alt = "backyard porch sitting area"/>
    <div className="wrapper">
    <h3 className = "sectionTitle">What's out here?</h3>
